from tasks import (
    ...
    parrot_mistral_lora_trainer_task
)
...
TASK_MANAGEMENT = {
    ...
    "parrot_mistral_lora_trainer_task": {
        "queue_name": "parrot_mistral_lora_trainer_queue", 
        "task_name": "parrot_mistral_lora_trainer_task",
        "load_model_function": parrot_mistral_lora_trainer_task
    },
}
